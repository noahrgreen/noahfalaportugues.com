...
const userDataDir = '/Users/noahgreen/Library/Application Support/Google/Chrome';
...
try {
  ...
  if (page.url().includes('accounts.google.com')) {
    status = 'profile_not_authenticated_in_playwright';
  } else {
...
await page.screenshot({ path: '/Users/noahgreen/NGO/noahfalaportugues.com/docs/screenshots/youtube-channel-logo-update-profile35-attempt.png', fullPage: true });
